  ...
  _eval(e, frame) {
    ...
    switch (e.type) {
      ...
      case 'sub': {
        ...
        if (typeof base === 'string' && this._heap[base]) {
          const o = this._heap[base];
          if (o.kind === 'list') { const i2 = idx < 0 ? o.items.length + idx : idx; return o.items[i2]; }
...
(function () {
  ...
  function start() { const cm = getCM(); if (!cm) { setTimeout(start, 50); return; } observer.observe(cmHost, { childList: true, subtree: true }); applyEditorZoom(); }
  start();
})();
